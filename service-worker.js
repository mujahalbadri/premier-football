...
if (workbox) {
    ...
    workbox.precaching.precacheAndRoute([
        ...
        { url: '/img/icon/logo-push.png', revision: '1' },
        { url: '/img/icon/icon-192x192.png', revision: '1' },
        { url: '/img/icon/icon-512x512.png', revision: '1' },
        { url: '/css/materialize.min.css', revision: '1' },
        { url: '/css/style.css', revision: '1' },
        { url: '/css/Material Icon/Material-icon.css', revision: '1' },
        { url: '/css/Material Icon/flUhRq6tzZclQEJ-Vdg-IuiaDsNc.woff2', revision: '1' },
        ...
        { url: '/img/icon/sidenav-logo.png', revision: '1' },
